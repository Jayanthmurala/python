    ...
    def run_traffic_cycle(self):
        ...
        for i, junction in enumerate(self.junctions):
            ...
            for line, data in junction.get_priority_lines():
                # Calculate green, yellow, and red times
